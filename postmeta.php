...
===*/
	...
	$this->pagesadded_met = array(
		...
		$this->pagesadded_met = apply_filters('wpr_postmeta_fullargsedit', $this->pagesadded_met);
		...
		foreach ($this->pagesadded_met['fields'] as $value) {
			...
			switch ($value['type']) {
				...
				<div class="metabox" style="display:block;width:100%;padding:10px;">
					...
					<div style="float:left;width:75%;">
						<input id="<?php echo $value['id']; ?>" class="met_<?php echo $value['type']; ?>" type="text" size="120" name="<?php echo $postarr . '[' . $value['id'] . ']'; ?>" value="<?php echo $metabox; ?>" <?php if($value['decimal'] && $value['decimal'] == 'true'){ ?>onkeyup="if(/\D/g.test(this.value)){this.value = this.value.replace(/\D/g,'');}" <?php } ?> placeholder="<?php echo isset($value["placeholder"])?$value["placeholder"]:""; ?>"/>
					</div>
					<br class="clear" />
				</div>
				<?php
				...
				?>
				<div class="metabox" style="display:block;width:100%;padding:10px;">
					<div class="chck" style="float:left; margin-right: 10px">
						<label for="<?php echo $value['id']; ?>"><?php echo $value['name']; ?></label>
						<p class="description"><?php echo $value['desc']; ?></p>
					</div>
				...
				<div class="metabox" style="display:block;width:100%;padding:10px;">
					...
					<div style="float:left;width:90%;">
						<textarea id="<?php echo $value['id']; ?>" class="<?php echo $value['id']; ?>" type="text" name="<?php echo $postarr . '[' . $value['id'] . ']'; ?>" placeholder="<?php echo isset($value["placeholder"])?$value["placeholder"]:""; ?>"><?php echo $metabox; ?></textarea>
					</div>
					<br class="clear" />
				</div>
				<?php
